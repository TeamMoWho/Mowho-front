...
export default function movieScreen({ onNavigate }: movieScreenProps) {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        <View style={styles.titleBlock}>
          <Image source={require('../../assets/images/categories/movie.png')} style={styles.titleIcon} resizeMode="contain" />
          <View style={styles.titleTextBlock}>
            <Text style={styles.titleText}>영화/OTT 카테고리를 추천드려요</Text>
          </View>
        </View>
