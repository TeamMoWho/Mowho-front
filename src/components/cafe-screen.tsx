...
export default function CafeScreen({ onNavigate }: CafeScreenProps) {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        <View style={styles.titleBlock}>
          <Image source={require('../../assets/images/categories/cafe.png')} style={styles.titleIcon} resizeMode="contain" />
          <View style={styles.titleTextBlock}>
            <Text style={styles.titleText}>카페 카테고리를 추천드려요</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  divider: { height: 1, backgroundColor: '#D0D0D0', marginBottom: 10 },
