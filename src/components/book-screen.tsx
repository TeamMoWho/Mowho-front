...
interface ubookScreenProps {
  onNavigate?: (tabId: string) => void;
}

export default function ubookScreen({ onNavigate }: ubookScreenProps) {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        <View style={styles.titleBlock}>
          <Image source={require('../../assets/images/categories/book.png')} style={styles.titleIcon} resizeMode="contain" />
          <View style={styles.titleTextBlock}>
            <Text style={styles.titleText}>독서 카테고리를 추천드려요</Text>
          </View>
        </View>
