...
export default function clothesScreen({ onNavigate }: clothesScreenProps) {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        <View style={styles.titleBlock}>
          <Image source={require('../../assets/images/categories/clothes.png')} style={styles.titleIcon} resizeMode="contain" />
          <View style={styles.titleTextBlock}>
            <Text style={styles.titleText}>옷 카테고리를 추천드려요</Text>
          </View>
        </View>
