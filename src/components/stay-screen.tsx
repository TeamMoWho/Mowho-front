...
export default function stayScreen({ onNavigate }: stayScreenProps) {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        <View style={styles.titleBlock}>
          <Image source={require('../../assets/images/categories/stay.png')} style={styles.titleIcon} resizeMode="contain" />
          <View style={styles.titleTextBlock}>
            <Text style={styles.titleText}>숙박 카테고리를 추천드려요</Text>
          </View>
        </View>
